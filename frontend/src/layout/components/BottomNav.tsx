...
export const BottomNav = () => {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-t from-black via-black/95 to-black/80 backdrop-blur-lg flex justify-around items-center h-[64px] z-[1000] safe-area-bottom">
            <Link to="/" className={`flex flex-col items-center gap-0.5 py-2 px-6 transition-all duration-200 ${isActive('/') ? 'text-white' : 'text-neutral-500'}`}>
            ...
            <Link to="/search" className={`flex flex-col items-center gap-0.5 py-2 px-6 transition-all duration-200 ${isActive('/search') ? 'text-white' : 'text-neutral-500'}`}>
            ...
            <Link to="/liked" className={`flex flex-col items-center gap-0.5 py-2 px-6 transition-all duration-200 ${isActive('/liked') ? 'text-white' : 'text-neutral-500'}`}>
