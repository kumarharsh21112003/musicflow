...
const AddSongDialog = () => {
	...
	return (
		<Dialog open={songDialogOpen} onOpenChange={setSongDialogOpen}>
			...
			<DialogContent className='bg-neutral-950 border-neutral-700 max-h-[80vh] overflow-auto'>
				<DialogHeader>
						...
						<div className='text-center'>
							{files.image ? (
								<div className='space-y-2'>
									...
									<div className='text-xs text-neutral-400'>{files.image.name.slice(0, 20)}</div>
								</div>
							) : (
								<>
									...
									<div className='text-sm text-neutral-400 mb-2'>Upload artwork</div>
